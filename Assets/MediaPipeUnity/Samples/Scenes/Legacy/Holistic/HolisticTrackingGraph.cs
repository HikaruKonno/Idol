...
namespace Mediapipe.Unity.Sample.Holistic
{
  ...
  public class HolisticTrackingGraph : GraphRunner
  {
    ...
    public bool refineFaceLandmarks = false;
        //public ModelComplexity modelComplexity = ModelComplexity.Lite;// 奥山：コメントアウト
    [SerializeField]
    public ModelComplexity modelComplexity = ModelComplexity.Heavy;// 奥山：追加
