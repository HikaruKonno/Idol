...
namespace Mediapipe.Unity.Sample
{
  ...
  public class AppSettings : ScriptableObject
  {
    ...
    [SerializeField] private ImageSource.ResolutionStruct[] _defaultAvailableWebCamResolutions = new ImageSource.ResolutionStruct[] {
      new ImageSource.ResolutionStruct(176, 144, 60),
      new ImageSource.ResolutionStruct(320, 240, 60),
      new ImageSource.ResolutionStruct(424, 240, 60),
      new ImageSource.ResolutionStruct(640, 360, 60),
      new ImageSource.ResolutionStruct(640, 480, 60),
      new ImageSource.ResolutionStruct(848, 480, 60),
      new ImageSource.ResolutionStruct(960, 540, 60),
      new ImageSource.ResolutionStruct(1280, 720, 60),
      new ImageSource.ResolutionStruct(1600, 896, 60),
